...
class ProdukController extends Controller
{
    ...
    {
        $produk = KategoriProduk::all(); //ini karena di tabel produk ada tabel kategori
        return view('admin.produk.create',compact('produk')); 
        // boleh kaya gini juga
        // return view('admin.produk.create',['data' => data]);
        //
    }
    ...
    {
        $produk = Produk::with('kategori_produk')->find($id);
        $data_kategori = KategoriProduk::all();// ini variabel buat naro kategori produk
